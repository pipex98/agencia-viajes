    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ComisionReserva>(entity =>
        {
            ...
            entity.Property(e => e.MontoComision)
                .HasComputedColumnSql("(CONVERT([decimal](10,2),([monto_base_reserva]*[porcentaje_comision])/(100)))", true)
                .HasColumnType("decimal(10, 2)")
        ...
        modelBuilder.Entity<DetalleReserva>(entity =>
        {
            ...
            entity.ToTable("detalle_reserva", tb => tb.HasTrigger("TR_DetalleReserva_INS_AFT"));
            ...
            entity.Property(e => e.Importe)
                .HasComputedColumnSql("(CONVERT([decimal](10,2),[cantidad]*[precio_unitario]))", true)
                .HasColumnType("decimal(10, 2)")
        ...
        modelBuilder.Entity<Reserva>(entity =>
        {
            ...
            entity.Property(e => e.Total)
                .HasComputedColumnSql("(CONVERT([decimal](10,2),[subtotal]+[subtotal]*[iva]))", true)
                .HasColumnType("decimal(10, 2)")
                .HasColumnName("total");
